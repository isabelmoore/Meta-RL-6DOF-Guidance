...
class Geo():
    ...
    def get_random_position_in_circle(self, lat0 , long0, d = [40e3, 100e3], b = [0, 360]):
        # input in [km] 
        # get a random lat long for aircraft/UAV position
        # lat0, long0 [deg]
        # d [km] distance 
        # b [deg] bearing 
...
class CircleClip():
    ...
    def reset(self, ref_init, b = 70):
        ...
        '''
        Cliping function for circle. If UAV is fired in 0 deg direction, operational bound is limited between -b to b 
        etc 290 deg to 70 
